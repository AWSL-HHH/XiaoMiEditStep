...
def get_sleep_time():
    ...
    # 第二天7点时间戳
    tomorrow_run_time = int(time.mktime(time.strptime(str(tomorrow), '%Y-%m-%d'))) + random.randint(46800,54000)
...
if __name__ == "__main__":
    ...
    while fail_num > 0:
        try:
            # 执行一键修改步数
            XiaomiSport( id , key , random.randint(10000,20000)).one_click_change_step()
            break
